			...
			<div className="btn-block">
				<button onClick={inc} className="btn btn-inc">
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 50 50">
						<g>
							<path d="M42.8,21.2h-15v-15C27.8,5.5,26.9,4,25,4c-1.9,0-2.8,1.5-2.8,2.2v15h-15C6.5,21.2,5,22.1,5,24c0,1.9,1.5,2.8,2.2,2.8h15v15c0,0.7,0.9,2.2,2.8,2.2s2.8-1.5,2.8-2.2v-15h15c0.7,0,2.2-0.9,2.2-2.8C45,22.1,43.5,21.2,42.8,21.2z" />
						</g>
					</svg>
				</button>
				<button onClick={dec} className="btn btn-dec">
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 50 20">
						<g>
							<path d="M40.3,5H29.8h-9.5H9.7C7.1,5,5,7.2,5,9.8c0,2.6,2.1,4.8,4.7,4.8h10.5h9.5h10.5c2.6,0,4.7-2.2,4.7-4.8C45,7.2,42.9,5,40.3,5z" />
						</g>
					</svg>
				</button>
